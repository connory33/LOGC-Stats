...
**To deploy manually (alternative method):**
```bash
cd react-app
npm run deploy
```
This will deploy to the `gh-pages` branch. If using this method, set GitHub Pages Source to "Deploy from a branch" → `gh-pages`.
